        ...
        <section className="relative w-full h-[70vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] min-h-[400px] sm:min-h-[500px] md:min-h-[500px] lg:min-h-[700px] overflow-hidden select-none">
            ...
            <AnimatePresence mode="wait">
                <motion.img
                    ...
                    alt="Card"
                    className="absolute top-[32%] right-[8%] sm:right-[18%] md:right-[40%] w-16 sm:w-24 md:w-48 lg:w-64 rounded-xl shadow-2xl z-[8] pointer-events-none block opacity-90" initial={{ y: 50, opacity: 0, rotate: -15 }}
