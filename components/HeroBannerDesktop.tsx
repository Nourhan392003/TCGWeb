...
export default function HeroBanner() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-[15] flex h-full items-start justify-center px-3 pt-4 sm:px-8 sm:pt-10">                <div className="w-[min(92vw,320px)] sm:w-full sm:max-w-lg lg:max-w-xl">
                {/* ── Subtitle badge ── */}
