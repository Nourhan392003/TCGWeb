            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-12">
                ...
                {products.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                        ...
                        <Link
                            href="/products"
                            className="mt-8 px-6 py-2.5 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 transition-colors text-sm"
                        >
                            {tPre("browse")}
                        </Link>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="aspect-[3/4] relative overflow-hidden bg-[#1a1a24]">
                                        ...
                                        >
                                            <Heart
                                                className={`w-3 h-3 sm:w-4 sm:h-4 ${inWishlist ? "fill-red-500 text-red-500" : "text-white"
                                                    }`}
                                            />
                                        </button>

                                        <div
                                            className={`absolute top-2 ${isRTL ? "right-2" : "left-2"} z-10 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full bg-amber-500/80 backdrop-blur-md text-[10px] sm:text-xs font-medium text-black border border-amber-400`}
                                        >
                                            {tPre("badge")}
                                        </div>
                                    </div>
